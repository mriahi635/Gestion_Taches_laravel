                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="kanban-column">
                            ...
                            @endforelse
                            <div class="mt-3">
                                <a href="{{ route('routines.showDaily') }}" class="btn btn-primary">View All Daily
                                    Routines</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="kanban-column">
                            ...
                            @endforelse
                            <div class="mt-3">
                                <a href="{{ route('routines.showWeekly') }}" class="btn btn-primary">View All Weekly
                                    Routines</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="kanban-column">
                            ...
                            @endforelse
                            <div class="mt-3">
                                <a href="{{ route('routines.showMonthly') }}" class="btn btn-primary">View All Monthly
                                    Routines</a>
                            </div>
                        </div>
                    </div>
